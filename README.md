...
- Screening: AI-assisted primary screen; **100% independently dual-screened** by two co-authors (κ = 0.830 / 0.689 pre-resolution); all disagreements adjudicated by consensus.
...
Data and documentation: CC BY 4.0. Code: MIT. Please cite the paper above (and this repository) when reusing the corpus or audit instruments. A versioned DOI (Zenodo) will be attached at journal acceptance.
